    ...
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left ">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between px-[6rem]">
        ...
        <div className="flex justify-center">
          <Link
            to={"https://www.facebook.com/shimu.mallick?mibextid=ZbWKwL"}
          ...
          <Link
            to={"https://www.linkedin.com/in/shimu-mallick"}
            className="mr-6 text-neutral-600 dark:text-neutral-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link
            to={"https://github.com/zeroBug404"}
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3 align-middle px-[6rem]">
          {/* <!-- Products section --> */}
          <div className="">
